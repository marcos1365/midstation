...
var dez=window.document.getElementById('dez')
...
seis.addEventListener('click',verificarSeis)
sete.addEventListener('click',verificarSete)
oito.addEventListener('click',verificarOito)
nove.addEventListener('click',verificarNove)
dez.addEventListener('click',verificarDez)
...
function verificarSeis(){verificar(6)}
function verificarSete(){verificar(7)}
function verificarOito(){verificar(8)}
function verificarNove(){verificar(9)}
function verificarDez(){verificar(10)}
...
function removeClique(){
    ...
    seis.removeEventListener('click',verificarSeis)
    sete.removeEventListener('click',verificarSete)
    oito.removeEventListener('click',verificarOito)
    nove.removeEventListener('click',verificarNove)
    dez.addEventListener('click',verificarDez)
}