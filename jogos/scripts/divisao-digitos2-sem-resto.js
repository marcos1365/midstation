...
function imgNumerosB7(e){
    ...
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(id==numeros[x]){imgB7.src='imagens/'+numeros[x]+'.png'} }
...
function imgNumerosTouchB7(){
    imgB7.className='numero'
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(numeroTouch==numeros[x]){imgB7.src='imagens/'+numeros[x]+'.png'} }
    b7.appendChild(imgB7)
...
function imgNumerosB8(e){
    ...
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(id==numeros[x]){imgB8.src='imagens/'+numeros[x]+'.png'} }
...
function imgNumerosTouchB8(){
    imgB8.className='numero'
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(numeroTouch==numeros[x]){imgB8.src='imagens/'+numeros[x]+'.png'} }
    b8.appendChild(imgB8)
...
function imgNumerosB9(e){
    ...
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(id==numeros[x]){imgB9.src='imagens/'+numeros[x]+'.png'} }
...
function imgNumerosTouchB9(){
    imgB9.className='numero'
    var numeros=['zero','um','dois','tres','quatro','cinco','seis','sete','oito','nove']
    for(var x=0;x<10;x++){ if(numeroTouch==numeros[x]){imgB9.src='imagens/'+numeros[x]+'.png'} }
    b9.appendChild(imgB9); 
