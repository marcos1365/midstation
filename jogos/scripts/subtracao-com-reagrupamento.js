...
b3.addEventListener('click',e=>{
    ...
    b3.innerHTML=a-1
    b4.innerHTML='1'
    b4.style.fontSize='40pt'
    b4.style.textAlign='right'
    b4.style.display='flex'; b4.style.flexDirection='column'; b4.style.justifyContent='flex-end'    
    b4.style.verticalAlign='text-bottom'
    b4.style.marginTop='-4px'
    b3.style.color='#4F4F4F'
    b4.style.color='#4F4F4F'
})
